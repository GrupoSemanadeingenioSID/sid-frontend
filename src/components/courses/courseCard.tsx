...
export default function CourseCard() { 
    return (
        <article className="flex flex-col h-72 w-full hover:scale-105 transition-all gap-2.5 bg-french-gray rounded-3xl p-2.5 md:w-[30%] lg:h-80 lg:w-[28%]">
            {/* IMAGEN DEL CURSO */}
            ...
            <div className='h-1/2 flex flex-col justify-between p-2.5'>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="bg-lapiz-lazuli rounded-md font-semibold px-2.5 py-1.5 flex items-center justify-center text-center text-xs lg:text-sm">
                        <p>Tecnología</p>
                    </div>
                </div>
